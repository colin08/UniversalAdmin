...
namespace Universal.Web.Areas.Admin.Controllers
{
    ...
    public class MedicalItemController : BaseAdminController
    {
        ...
        public ActionResult Index(int page = 1,int cid=0,string word = "")
        {
            ...
            if (cid > 0)
            {
                filter.Add(new BLL.FilterSearch("MedicalItemCategoryID", cid.ToString(), BLL.FilterSearchContract.等于));
            }


            BLL.BaseBLL<Entity.MedicalItem> bll = new BLL.BaseBLL<Entity.MedicalItem>();
            var list = bll.GetPagedList(page, response_model.page_size, ref total, filter, "Weight desc", "MedicalItemCategory");
        ...
        public ActionResult Edit(Entity.MedicalItem entity)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else //修改
                {
                    ...
                    user.MedicalItemCategoryID = entity.MedicalItemCategoryID;
        ...
        private void Load()
        {
            ...
            dataList.Add(new SelectListItem() { Text = "选择分类", Value = "0" });
            var db_list = new BLL.BaseBLL<Entity.MedicalItemCategory>().GetListBy(0, p => p.Status, "Weight DESC");
