...
//        [AdminPermissionAttribute("分类管理", "分类管理首页", true)]
//        public ActionResult Index()
//        {
//            return View(LoadCategory());
//        }

//        [AdminPermissionAttribute("分类管理", "删除分类", true)]
//        [HttpPost]
...
//        /// <returns></returns>
//        [AdminPermissionAttribute("分类管理", "分类管理编辑页面", true)]
...
//        [AdminPermissionAttribute("分类管理", "保存分类管理编辑信息", true)]
