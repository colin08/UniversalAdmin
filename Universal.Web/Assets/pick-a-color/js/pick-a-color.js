      ...
      var markupAfterInput = function () {
        ...
        if (useTabs) {
          ...
          if (settings.showSavedColors) {
            $tabContainer.append($("<span>").addClass(savedColorsClass).append($("<a>").text("历史")));
          }
        ...
        if (settings.showAdvanced) {
          ...
          var $advanced = $("<div>").addClass("advanced-content").addClass(advancedColorsActiveClass).
              ...
              $hueContent = $("<span>").addClass("hue-text").
                text("色调: ").append($("<span>").addClass("hue-value").text("0"));
          ...
          var $lightnessItem = $("<li>").addClass("lightness-item"),
            ...
            text("亮度: ").append($("<span>").addClass("lightness-value").text("50%"));
          if (isIELT10) {
            $.each([0,1], function (i) {
          ...
          var $saturationContent = $("<span>").addClass("saturation-text").
            text("饱和度: ").append($("<span>").addClass("saturation-value").text("100%"));
          ...
          var $previewItem = $("<li>").addClass("preview-item").append($("<span>").
              addClass("preview-text").text("预览")),
            $preview = $("<span>").addClass("color-preview advanced").
              append("<button class='color-select btn btn-mini advanced' type='button'>选择</button>");
        ...
        calculateHighlightedColor: function () {
          ...
          if (tab === "basic") {
            ...
            $thisParent.prev('.color-label').replaceWith(
              '<button class="color-select btn btn-mini" type="button">选择</button>');
