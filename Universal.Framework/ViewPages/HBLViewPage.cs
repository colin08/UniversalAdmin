...
namespace Universal.Web.Framework
{
    ...
    public abstract class HBLViewPage<TModel> : System.Web.Mvc.WebViewPage<TModel>
    {
        ...
        public override void InitHelpers()
        {
            ...
            WorkContext = ((BaseHBLController)(this.ViewContext.Controller)).WorkContext;
        }
    }
    ...
    /// 后台视图页面基类型
    /// </summary>
    public abstract class HBLViewPage : HBLViewPage<dynamic>
    {
